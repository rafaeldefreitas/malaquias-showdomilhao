...
public final class cabecalho_jsp extends org.apache.jasper.runtime.HttpJspBase
         ...
         request.getParameter("txtSenha")!=null)
 {
  ...
  response.sendRedirect("index-logado.jsp");
   }
   else{
       msg="Errou";
   }
      ...
      out.write("            <h4>Admistrador - Entrar</h4>\n");
      out.write("          <form action=\"cabecalho-index.jsp\" method=\"post\">\n");
      out.write("                <!-- \n");
      ...
      out.write("                <div class=\"mdl-cell--12-col\">\n");
      out.write("                    \n");
      out.write("                    <button type=\"submit\" class=\"mdl-button mdl-js-button mdl-button--accent\" > OK </button>\n");
      out.write("\n");
      out.write("</button>\n");
      out.write("\n");
      out.write("    </div>\n");
